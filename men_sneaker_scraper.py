...
product_links = []
# Here we are using soup object to find all the links to Men's shoe on the Nike website
...
# Using pandas to create a dataframe that will contain instance of Men'a sneakers from Nike
